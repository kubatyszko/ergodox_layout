...
KB_MATRIX_LAYER(
	...
	KEY_Tab,	KEY_q_Q,	KEY_w_W,	KEY_e_E,	KEY_r_R,	KEY_t_T,	KEY_Insert,	
	KEY_Dash_Underscore,	KEY_a_A,	KEY_s_S,	KEY_d_D,	KEY_f_F,	KEY_g_G,	
	KEY_DeleteBackspace,	KEY_z_Z,	KEY_x_X,	KEY_c_C,	KEY_v_V,	KEY_b_B,	0,	
	KEY_Home,	KEY_End,	KEY_PageUp,	KEY_PageDown,	KEY_LeftShift,	
	KEY_LeftAlt,	2,	
	0,	0,	KEY_LeftShift,	
	KEY_Spacebar,	KEY_LeftControl,	KEY_RightGUI,	
	// right hand
	KEY_Equal_Plus,	KEY_6_Caret,	KEY_7_Ampersand,	KEY_8_Asterisk,	KEY_9_LeftParenthesis,	KEY_0_RightParenthesis,	KEY_RightBracket_RightBrace,	
	KEY_DeleteForward,	KEY_y_Y,	KEY_u_U,	KEY_i_I,	KEY_o_O,	KEY_p_P,	KEY_LeftBracket_LeftBrace,	
	KEY_h_H,	KEY_j_J,	KEY_k_K,	KEY_l_L,	KEY_Semicolon_Colon,	KEY_SingleQuote_DoubleQuote,	
	KEY_DeleteBackspace,	KEY_n_N,	KEY_m_M,	KEY_Comma_LessThan,	KEY_Period_GreaterThan,	KEY_Slash_Question,	KEY_Backslash_Pipe,	
	KEY_RightShift,	KEY_LeftArrow,	KEY_DownArrow,	KEY_UpArrow,	KEY_RightArrow,	
	2,	KEY_RightAlt,	
	0,	0,	0,	
	KEY_Application,	KEY_RightControl,	KEY_ReturnEnter	
),
// LAYER 1
KB_MATRIX_LAYER(
	// unused
	...
	KEY_h_H,	KEY_j_J,	KEY_k_K,	KEY_l_L,	KEY_Semicolon_Colon,	KEY_SingleQuote_DoubleQuote,	
	0,	KEY_n_N,	KEY_m_M,	KEY_Comma_LessThan,	KEY_Period_GreaterThan,	KEY_Slash_Question,	KEY_Backslash_Pipe,	
	0,	0,	0,	0,	0,	
	2,	0,	
	0,	0,	0,	
	0,	0,	0	
